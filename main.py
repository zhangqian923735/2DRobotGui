...
thread_pos_load = serial_widget_thread.msg_fresh_thr(SurgRobot)
thread_pos_load.name = "位置回读线程"
...
def open_posLoad_thread():
    global thread_pos_load
    thread_pos_load.start()
